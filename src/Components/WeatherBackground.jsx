...
const WeatherBackground = ({ condition }) => {
    ...
    return(
        <div className='fixed inset-0 z-0 overflow-hidden'>
            {background === video ?(
                <video autoPlay loop muted className='w-full h-full object-cover opaccity-100 pointer-events-none
                animate-fade-in'>
                    <source src={video} type='video/mp4' />
                </video>
            ) : (
                <img src={background} alt="weather-bg" className='w-full h-full object-cover opaccity-20 pointer-events-none
                animate-fade-in' />
            )}
